...
public class FileLoader {
	public static void main(String[] args) {
		String url = "http://localhost:8182/static/location-topic-model/wordmap.txt";
		String pathToLocalFile = "src/main/resources/wordmap.txt";
		FileLoader.getFile(url, pathToLocalFile);
	}
