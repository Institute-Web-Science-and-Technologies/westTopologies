...
import uniko.west.topology.bolts.LocationCrawlerBolt;
...
public class TopologyRunner {
    ...
    public static String topologyName = "lodExplorerTopology";  // the name is not important at this place it is just used in the storm UI
    ...
    public static void main(String[] args) {
        ...
        LocationCrawlerBolt locationCrawlerBolt = new LocationCrawlerBolt(emitFieldsId, restletURL);
